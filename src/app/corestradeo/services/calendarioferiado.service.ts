...
// DYNAMIC IMPORTS
import { CalendarioFeriado } from '@stradeo/domain/models/calendarioferiado.model';
import { environment } from '../../../environments/environment';
@Injectable({
providedIn: 'root',
})
export class CalendarioFeriadoService extends BaseService<
CalendarioFeriado,
...
super(http, `${environment.apiBase}/calendarioferiado`);
}
}