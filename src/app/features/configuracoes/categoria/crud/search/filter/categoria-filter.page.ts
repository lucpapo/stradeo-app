...
import { CategoriaFilterStrategy } from './categoria-filter.strategy';
@Component({
standalone: true,
selector: 'app-categoria-filter',
imports: [CommonModule, ReactiveFormsModule, ValidationIndicatorComponent],
templateUrl: './categoria-filter.page.html',
styleUrls: [],
})
export class CategoriaFilterPage extends BaseFilterPage < Record < string, any >> {
// A anotação de tipo do @Input também deve ser atualizada para ser consistente
@Input() override value!: Record<string, any>;
private strategy = new CategoriaFilterStrategy();
constructor() { super(); }
