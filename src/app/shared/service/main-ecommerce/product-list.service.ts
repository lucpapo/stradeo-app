...
import { SortColumn, SortDirection } from '../../directive/product-list.directive';
import { productListData, productListInterface } from '../../data/data/main-ecommerce/product-list';
