...
export var barChartChartData: any[] = [{
    ...
    backgroundColor: "rgba(103, 143, 68, 0.4)",
    borderColor: primary_color,
    highlightBackgroundColor: "rgba(103, 143, 68, 0.6)",
    borderWidth: 2,
    highlightBorderColor: primary_color,
    data: [35, 59, 80, 81, 56, 55, 40]
}, {
    label: "My Second dataset",
    backgroundColor: "rgba(209, 130, 63, 0.4)",
...
export var lineGraphData: any[] = [
    {
        label: "My First dataset",
        fill: true,
        backgroundColor: "rgba(103, 143, 68, 0.3)",
        borderColor: primary_color,
        ...
        label: "My Second dataset",
        fill: true,
        backgroundColor: "rgba(209, 130, 63, 0.3)",
        borderColor: secondary_color,
...
export var lineChartData: any[] = [
    {
        ...
        backgroundColor: "rgba(235, 163, 29, 0.2)",
        fill: true,
        borderColor: secondary_color,
        ...
        backgroundColor: "rgba(103, 143, 68, 0.2)",
        fill: true,
        borderColor: primary_color,
        pointBackgroundColor: primary_color,
        pointColor: primary_color,
...
export var doughnutChartColors: any[] = [{ backgroundColor: [primary_color, secondary_color, "#479447"] }];
