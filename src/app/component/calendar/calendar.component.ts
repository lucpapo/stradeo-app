...
import { CalendarCommonModule, CalendarDayModule, CalendarEvent, CalendarEventAction, 
  CalendarEventTimesChangedEvent, CalendarMonthModule, CalendarView, CalendarWeekModule } from 'angular-calendar';
