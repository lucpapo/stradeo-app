...
import { contactData, lastDataList } from '../../../../shared/data/data/all-contact';
import { PrintComponent } from '../../contact-modal/print/print.component';
import Swal from 'sweetalert2';
import { AddressContentComponent } from './edit-profile/address-content/address-content.component';
import { PersonalContentComponent } from './edit-profile/personal-content/personal-content.component';
...
@Component({
    ...
    standalone: true,
    imports: [CommonModule, FormsModule, GeneralComponent, 
      PersonalContentComponent, AddressContentComponent, PrintComponent]
})
